...
// void init_magics(Attack &attacks){
//     // std::cout << "Bishop\n";
//     // for (int sqr = 0; sqr < 64; sqr++){
//     //     std::cout << find_magic_number(sqr, bishop_relevant_occupancy_bits[sqr], BISHOP) << "ULL, ";
//     //     if ((sqr + 1) % 4 == 0)
//     //         std::cout << std::endl;
//     // }
...
//     U64 num;
//     for (int sqr = 0; sqr < 64; sqr++){
//         num = find_magic_number(sqr, rook_relevant_occupancy_bits[sqr], ROOK, attacks, randNum);
//         std::stringstream ss;
...
// static inline U64 get_bishop_attacks(int sqr, Attack &attacks, U64 occupancy);
// static inline U64 get_rook_attacks(int sqr, Attack &attacks, U64 occupancy);

// static inline U64 get_bishop_attacks(int sqr, Attack &attacks, U64 occupancy){
//     occupancy &= attacks.bishop_masks[sqr];
//     occupancy *= bishop_magics[sqr];
//     occupancy >>= (64 - bishop_relevant_occupancy_bits[sqr]);
//     return attacks.bishop_attacks[sqr][occupancy];
// }

// static inline U64 get_rook_attacks(int sqr, Attack &attacks, U64 occupancy){
//     occupancy &= attacks.rook_masks[sqr];
//     occupancy *= rook_magics[sqr];
//     occupancy >>= (64 - rook_relevant_occupancy_bits[sqr]);
//     return attacks.rook_attacks[sqr][occupancy];
// }
